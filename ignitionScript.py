...
def geoFunction():
    ...
    if answer == "yes":
        ...
        for x in range(5):
            ...
            if answer.lower().strip() in ("Alberta", "British Columbia", "B.C.", "BC", "Manitoba", "New Brunswick", "Newfoundland and Labrador", "Nova Scotia", "Ontario", "Quebec", "PEI", "P.E.I.", "P.E.I", "Prince Edward Island", "Saskatchewan"):
                print("Correct!")
                points = points + 1
            else:
                print("Incorrect")
